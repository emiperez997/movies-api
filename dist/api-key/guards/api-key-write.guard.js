...
let ApiKeyGuardWrite = class ApiKeyGuardWrite {
    ...
    async canActivate(context) {
        ...
        if (apiKeyData.type !== api_key_schema_1.ApiKeyType.WRITE &&
            apiKeyData.type !== api_key_schema_1.ApiKeyType.ALL) {
            throw new common_1.UnauthorizedException("No tiene permisos para realizar esta acción");
        }
        return true;
    }
};
exports.ApiKeyGuardWrite = ApiKeyGuardWrite;
exports.ApiKeyGuardWrite = ApiKeyGuardWrite = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [api_key_service_1.ApiKeyService])
], ApiKeyGuardWrite);
//# sourceMappingURL=api-key-write.guard.js.map